                ...
                <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 md:p-10 shadow-lg border border-gray-100 dark:border-gray-800">
                                    ...
                                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm space-y-6">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 dark:text-gray-400 text-sm mb-2">진료 시간 내 언제든 문의 가능합니다.</p>
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-600 dark:text-gray-400 text-sm mb-3">간편하게 모바일로 예약하세요.</p>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
                                            <h4 className="font-bold text-gray-900 dark:text-white text-sm mb-2">📌 초진 시 예약이 필수인가요?</h4>
                                            <p className="text-gray-600 dark:text-gray-400 text-sm">
                                                전화 예약 후 방문을 권장합니다. 당일 현장 접수 시 대기 시간이 길어지거나 진료가 어려울 수 있습니다.
                                            </p>
                                        </div>
                                        <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
                                            <h4 className="font-bold text-gray-900 dark:text-white text-sm mb-2">📌 초진 시 신분증이 필요한가요?</h4>
                                            <p className="text-gray-600 dark:text-gray-400 text-sm">
                                                네, 의료법 개정에 따라 <strong>본인 확인 절차가 의무화</strong>되어 신분증을 반드시 지참하셔야 합니다.
                                            </p>
                                        </div>
                                        <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
                                            <h4 className="font-bold text-gray-900 dark:text-white text-sm mb-2">📌 진료 기록이 남나요?</h4>
                                            <p className="text-gray-600 dark:text-gray-400 text-sm">
                    ...
                    {activeTab === "non-insurance" && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 text-center">
                            ...
                            <div className="max-w-4xl mx-auto rounded-xl overflow-hidden shadow-sm border border-gray-200 dark:border-gray-700">
                                <img
                                    src="/images/non_insurance_placeholder.png"
                                    alt="비급여 진료 항목 안내"
                                    className="w-full h-auto"
                                    onError={(e) => {
                                        e.currentTarget.src = "https://placehold.co/800x1200?text=Non-Insurance+Information";
                                    }}
                                />
                            </div>
                        </div>
